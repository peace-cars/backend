  ...
  async create(userId: string, data: any) {
    ...
    const { data: plan, error } = await supabase
      ...
      .insert([{
        ...
        total_price_etb: data.loanAmountEtb,
        duration_months: data.termMonths,
        interest_rate_percent: data.interestRate,
        monthly_installment_etb: data.monthlyPaymentEtb,
